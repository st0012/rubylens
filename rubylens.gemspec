...
Gem::Specification.new do |specification|
  ...
  specification.files = [
    ...
    "exe/rubylens",
    "lib/rubylens.rb",
    *Dir["lib/rubylens/{art_model_builder,cli,configuration,errors,generator,git_repository,paths,rails_framework,report_asset_assembler,report_writer,showcase_generator,showcase_model,showcase_writer,version}.rb"],
