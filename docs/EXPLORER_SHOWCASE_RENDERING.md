...
Both surfaces also share deterministic package-plane orientation, package-cloud rotation, and a transient 2D travel overlay derived from bounded constant-reference candidates. Neither adds scene points or persistent edges.
