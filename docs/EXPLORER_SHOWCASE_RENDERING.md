...
| Rendering passes | Core/Test use additive glow, body, and white-hot-core passes; dependency marks omit the glow pass | All categories use the three additive passes, with Showcase's fixed glow and brightness presets |
