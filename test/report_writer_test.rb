...
class ReportWriterTest < Minitest::Test
  ...
  def test_writes_an_offline_owner_only_report_and_protects_default_directory
    Dir.mktmpdir("rubylens-report-") do |directory|
      ...
      assert_includes(html, "if (cameraFlight) {")
      ...
      assert_includes(html, "Double-click dependency systems or gem subclouds")
      ...
      assert_includes(html, "focusedDependencyPoint ? 1 : contextVisibility.package")
      ...
      assert_includes(html, "const detailedPoint = emphasis >= .1")
      ...
      assert_includes(html, "const pinned = showcaseDetails ? Array.from(showcasePointsByAnchor.values()) : []")
