...
class ReportWriterTest < Minitest::Test
  ...
  def test_writes_an_offline_owner_only_report_and_protects_default_directory
    Dir.mktmpdir("rubylens-report-") do |directory|
      ...
      assert_includes(html, "renderPoints.forEach((point, index) =>")
      ...
      refute_includes(html, "SHOWCASE_POINT_LIMIT")
      refute_includes(html, "showcasePointSample")
      refute_includes(html, "renderShowcaseFallback")
      refute_includes(html, "canvas2d-fallback")
