...
const EXPORTS = `;return ({
  ...
  HAZE_CATEGORY_OFFSET, HAZE_RECIPE, EXPLORER_MILK_PRESET, ...hazeBuffers(),
  ...
  project, projectCoordinates, scenePointWorldPosition, projectScenePoint, viewMatrix, visibleCategories,
  ...
  travelEpisodesThrough, travelStatesAt, projectTravelRoutePoint,
  travelGuideFits, quadraticCoordinate,
